...
//     x: custom % 2 === 0 ? -50 : 50, // Even index: left, Odd index: right
//     y: 12, // Small vertical offset to match website style
//     opacity: '0',
//     filter: 'blur(12px)',
//   }),
...
//       filter: {
//         type: 'spring',
//         bounce: 0, // Prevents overshooting
//         duration: 1.5,
//       },
//       delay: custom * 0.2, // Staggered delay from original
//     },
//   }),
// };

// Variants for larger screens: animate in from bottom one by one
        ...
        <div className='relative space-y-8 md:space-y-16'>
          ...
          <div className='relative z-10 grid grid-cols-6 gap-4'>
            <motion.div
              ...
              viewport={{ once: true }}
              className='col-span-full flex overflow-hidden lg:col-span-2'
            >
              <Card className='relative w-full h-full flex flex-col'>
                <CardContent className='relative m-auto flex flex-col justify-center items-center size-fit'>
                  <div className='relative flex h-24 w-56 items-center'>
                    <svg
                      className='text-foreground dark:text-accent absolute inset-0 size-full'
                      viewBox='0 0 254 104'
                      fill='none'
                  ...
                  <p className='mt-4 text-center text-foreground'>
                    ...
                    challenges perfectly. Experience a website that truly
                    reflects your identity and scales with your success.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
            ...
            >
              <Card className='relative w-full h-full flex flex-col'>
                <CardContent className='pt-6'>
                  <div className='relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border border-blue-400/60 before:border-blue-400/50  dark:border-blue-400/40 dark:before:border-blue-400/30'>
                    <svg
                  ...
                  <div className='relative z-10 mt-6 space-y-2 text-center'>
                    <h2 className='group-hover:text-secondary-950 text-2xl font-medium transition dark:text-white'>
                      Secure by default
                    </h2>
                    <p className='text-foreground'>
                      Your security is our priority. We integrate
                      industry-leading security measures from the start,
                      ensuring your data and customer trust remain
                  ...
                  <div className='pt-6 lg:px-6'>
                    ...
                    >
                      ...
                      <g clipPath='url(#clip0_0_106)'>
                        <circle
                          className='text-accent dark:text-muted'
                          cx='29'
                          cy='29'
                          r='15'
                          fill='currentColor'
                        />
                        <path
                          d='M13 2 3 14 12 14 11 22 21 10 12 10 13 2'
                          stroke='#EAB308'
                          strokeWidth='2'
                          strokeLinecap='round'
                          strokeLinejoin='round'
                          transform='translate(19.5, 19) scale(0.8)'
                        />

                        <text x='55' y='33' fill='currentColor' fontSize='14'>
                          Super Speed
                        </text>
                      ...
                      />
                      <path
                        className='text-yellow-400 dark:text-yellow-400/90'
                ...
                <CardContent className='grid pt-6 sm:grid-cols-2'>
                  <div className='relative z-10 flex flex-col space-y-12 lg:space-y-6'>
                    <div className='relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border border-gray-700 before:border-gray-800 dark:border-white/10 dark:before:border-white/5'>
                      <Star className='m-auto size-6' strokeWidth={2} />
                    </div>
                    <div className='space-y-2'>
                      <h2 className='group-hover:text-secondary-950 text-2xl font-medium text-zinc-800 transition dark:text-white'>
                        Proven Excellence, Trusted Results
                      </h2>
                      <p className='text-foreground'>
                        Our clients see real impact increased engagement,
                        stronger brands, and measurable growth. Join a growing
                        roster of satisfied clients who have transformed their
                        digital footprint with our expert guidance. From
                        startups to established enterprises, our strategies
                        deliver measurable impact, building lasting trust and
                  ...
                  <div className='rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6'>
                    <div className='absolute left-3 top-2 flex gap-1'>
                      <span className='block size-2 rounded-full border border-white/10 bg-red-500/90 dark:border-white/10 dark:bg-red-500/90'></span>
                      <span className='block size-2 rounded-full border border-white/10 bg-yellow-400/90 dark:border-white/10 dark:bg-yellow-400/90'></span>
                      <span className='block size-2 rounded-full border border-white/10 bg-green-500/90 dark:border-white/10 dark:bg-green-500/90'></span>
                    </div>
                    <svg
                    ...
                    >
                      ...
                      />
                      <path
                        className='text-violet-500/90 dark:text-violet-500/90'
            ...
            >
              <Card className='relative '>
                <CardContent className='grid h-full pt-6 sm:grid-cols-2'>
                  <div className='relative z-10 flex flex-col space-y-12 lg:space-y-6'>
                    <div className='relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border border-gray-700 before:border-gray-800 dark:border-white/10 dark:before:border-white/5'>
                      <Handshake className='m-auto size-6' strokeWidth={2} />
                    </div>
                    <div className='space-y-2'>
                      <h2 className='text-2xl font-medium transition'>
                      ...
                      <p className='text-foreground'>
                        We’re here for you with fast, proactive help to keep
                        your site running smoothly and your business thriving.
                        We offer rapid responses, clear communication, and
                        proactive solutions—ensuring your business runs smoothly
                        without interruption. With us, you gain a reliable
                        partner committed to your continuous success.
                      </p>
                    </div>
                  </div>
                  <div className='before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6'>
                    <div className='relative flex h-full flex-col justify-center space-y-6 py-6'>
                      <div className='relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2'>
                        <span className='block rounded border px-2 py-1 text-xs shadow-sm'>
                          Englesson
                        </span>
                        <Avatar>
                          <AvatarImage
                            className='size-7 outline-1 outline-border rounded-full'
                            src='/englesson.png'
                          />
                      ...
                      <div className='relative ml-[calc(50%-1rem)] flex items-center gap-2'>
                        <Avatar>
                          <AvatarImage
                            className='size-8 outline outline-border rounded-full'
                      ...
                      <div className='relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2'>
                        ...
                        <Avatar>
                          <AvatarImage
                            className='size-7 outline outline-border rounded-full'
