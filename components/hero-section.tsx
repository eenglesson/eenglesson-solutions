        ...
        <section>
          <div className='relative pt-24 md:pt-36'>
            ...
            >
              <Image
                src={
                  'https://res.cloudinary.com/dg4jhba5c/image/upload/v1741605538/night-background_ni3vqb.jpg'
                }
                alt='background'
                className='absolute w-full inset-x-0 top-56 -z-20 hidden lg:top-32 dark:block'
                width={1920}
                height={1080}
              />
            </AnimatedGroup>
            ...
            >
              <div className='relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20'>
                ...
                <div className=' inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1'>
                  <Image
                    className='bg-background object-cover relative hidden rounded-2xl dark:block'
                    src='/heroDark.png'
                    alt='app screen'
                    width='2700'
                    height='1440'
