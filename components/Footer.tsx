      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6'>
          ...
          <div className='flex flex-col gap-8 w-full max-w-[400px]'>
            <div className='space-y-2'>
              <Link
                href='/'
                aria-label='go home'
                className='block size-fit font-medium'
              >
                E | Englesson
              </Link>
              <p className='text-sm text-muted-foreground'>
                Crafting exceptional digital experiences through clean design
                and efficient code. We build websites that not only look great
                today but remain adaptable and high-performing for years to
                come.
              </p>
            </div>
        ...
        <div className='mt-12 flex flex-wrap items-end justify-between gap-6 border-t py-6'>
          <span className='text-muted-foreground order-last block text-center text-sm md:order-first'>
            © {new Date().getFullYear()} E | Englesson All rights reserved.
          </span>
